...
<div class="row">
   <div class="col-md-10 offset-md-1 bg-white card  ">
      <form id="Form_cliente" action=" {{route('clients.update',$client->id)}} " method="PUT" class="was-validated m-5 "
         autocomplete="off">
         @csrf
         <div class="form-row ">
            ...
            <div class="form-group col-md-6 mb-3">
               <label for="ClientDireccion">Contraseña </label>
               <input type="text" name="direccion" class='form-control is-valid' value="{{ $client->direccion}}"
                  id='ClientDireccion' placeholder="Direccion  AV. " required>
               <div class="invalid-feedback">¡Debes de agregar una direccion!</div>
            </div>
                  ...
                  <div class="inner" id="data_contacto">
                     <div class="form-row row_contact">
                        <div class=" col-md-3 mb-3">
                           ...
                           <input type="text" class='form-control is-valid _nombre' id='ClientNombre'
                        ...
                        <div class=" col-md-3 mb-3">
                           ...
                           <input type="mail" class='form-control is-valid _correo' id='ClientCorreo'
                              placeholder="example@gmail.com " required>
                        </div>
                        <div class=" col-md-2 mb-3">
                           <label for="ClientTelefono">Telefono </label>
                           <input type="text" class='form-control is-valid _telefono' id='ClientTelefono'
                              placeholder="999999999 " required>
                        </div>
                        <div class=" col-md-1 mt-4 mb-1">
                           <button class="btn btn-outline-info  quitar_fill " type="button" href="#"><i
